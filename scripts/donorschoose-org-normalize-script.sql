DROP TABLE normalized_giftcard CASCADE;
DROP TABLE normalized_donation CASCADE;
DROP TABLE normalized_project CASCADE;
DROP TABLE normalized_school CASCADE;
DROP TABLE normalized_teacher CASCADE;
DROP TABLE normalized_account CASCADE;
DROP TABLE normalized_city CASCADE;
DROP TABLE normalized_essay CASCADE;
DROP TABLE normalized_resource CASCADE;
